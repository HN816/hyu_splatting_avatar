...
def run_testing_live(pipe, frameset_test, gs_model, pc_dir, verify=None):
    print(f"[run_testing_live] frameset_test type: {type(frameset_test)}")
    print(f"[run_testing_live] frameset_test length: {len(frameset_test) if frameset_test else 'None or empty'}")
